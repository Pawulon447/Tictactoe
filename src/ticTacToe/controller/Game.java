...
public class Game  {
    ...
    public void finishGame(String gameOutcome){
        switch (gameOutcome){
            case "win": { outputFX1.winMessage();break;}
            case "lose": { outputFX1.loseMessage();break;}
            case "draw": { outputFX1.drawMessage();break;}
            default: {
                System.out.println("invalid game outcome");break;
            }
        }
    }
